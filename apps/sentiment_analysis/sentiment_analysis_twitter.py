...
import apps.sentiment_analysis.sentiment_analysis_twitter_user_screener as tab1
...
id_start = idf.init_id('sentiment_analysis_twitter')
    ...
    dbc.Row([
        dbc.Col([
            dcc.Tabs(id=idf.gen_id(id_start, 'tabs'),
                     value='tab-1',
                     children=[
                         dcc.Tab(label='user screener', value='tab-1', style=tab_style,
                                 selected_style=tab_selected_style),
                         dcc.Tab(label='text screener', value='tab-2', style=tab_style,
                                 selected_style=tab_selected_style),
                     ],
                     colors={
                         "border": "grey",
