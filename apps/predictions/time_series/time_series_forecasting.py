...
import apps.predictions.time_series.holt_winters as tab1
import apps.predictions.time_series.arima as tab2
...
id_start = idf.init_id('time_series')
    ...
    dbc.Row([
        dbc.Col([
            dcc.Tabs(id=idf.gen_id(id_start, 'tabs'),
                     value='tab-1',
                     children=[
                         dcc.Tab(label='Holt-Winters', value='tab-1', style=tab_style,
                                 selected_style=tab_selected_style),
                         dcc.Tab(label='ARIMA', value='tab-2', style=tab_style,
                                 selected_style=tab_selected_style),
                     ],
                     colors={
                         "border": "grey",
